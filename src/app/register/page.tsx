...
const Registration: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        if (formData.password !== formData.confirmPassword)
            return toast.error("Password & confirmed password is not matched")
    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
            <Card className='w-full max-w-md'>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className='space-y-6'> {/* action={registrationAction} */}
                        {/* Full Name */}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <User className='absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-muted-foreground' />
                                <Input
                                    id='userName' type='text' placeholder='Choose a username' required
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    placeholder='Create a strong passsword' required
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <User className='absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-muted-foreground' />
                                <Input
                                    id='confirmedPassword' type={showConfirmPassword ? "text" : "password"}
                                    placeholder='Confirm Your Passsword' required
